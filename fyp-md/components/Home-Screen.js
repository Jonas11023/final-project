...
export default function HomeScreen({ navigation }) {
  ...
  // Replace your current fetchRainfall with this
  const fetchRainfall = async () => {
    try {
      // Replace the URL with your PC's local IP running the backend
      const response = await fetch("http://192.168.1.71:3000/rainfall");
      const data = await response.json();

      // Extract latest readings per region
      ...
      // Backend returns readings array
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.progressContainer}>
            ...
            <View style={styles.progressTextContainer}>
              ...
              <Text style={styles.progressText}>675 / 1000 XP</Text>
            </View>
